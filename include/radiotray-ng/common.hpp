...
// defaults
#define DEFAULT_BUFFER_DURATION_VAL			(2)
#define DEFAULT_BUFFER_SIZE_VAL				uint32_t(320000)
#define DEFAULT_BOOKMARK_EDITOR				"rtng-bookmark-editor"
#define DEFAULT_COMPACT_MENU_VAL				(false)
#define DEFAULT_DEBUG_LOGGING_VAL			(false)
#define DEFAULT_FILE_MONITOR_VAL				(true)
#define DEFAULT_FILE_MONITOR_INT_VAL		(10)
#define DEFAULT_HTTP_TIMEOUT_VAL				(15)
#define DEFAULT_INVERT_MENU_VAL				(false)
#define DEFAULT_M_KEY_MAPPING_VAL			(false)
#define DEFAULT_M_KEY_NEXT_STATION_VAL		"Next"
#define DEFAULT_M_KEY_PREV_STATION_VAL		"Previous"
#define DEFAULT_M_KEY_VOLUME_DOWN_VAL		""
#define DEFAULT_M_KEY_VOLUME_UP_VAL			""
#define DEFAULT_RTRAY_ICON_ON_VAL			"radiotray-ng-on"
#define DEFAULT_RTRAY_ICON_OFF_VAL			"radiotray-ng-off"
#define DEFAULT_RTRAY_NOTIFICATION_VAL		"radiotray-ng-notification"
#define DEFAULT_ROOT_GRP_BOTTOM_POS_VAL	(true)
#define DEFAULT_M_KEY_OLD_DBUS_NAME_VAL	(false)
#define DEFAULT_NOTIF_VAL						(true)
#define DEFAULT_NOTIF_VERBOSE_VAL			(true)
#define DEFAULT_SLEEP_TIMER_VAL				uint32_t(60)
#define DEFAULT_SPLIT_TITLE_VAL				(true)
#define DEFAULT_IHR_TITLE_KEY_VAL			(true)
#define DEFAULT_STATION_IMAGE_VAL			""
#define DEFAULT_TAG_INFO_VERBOSE_VAL		(false)
#define DEFAULT_STATION_NOTIFICATION_VAL	(true)
#define DEFAULT_TRACK_INFO_COPY_VAL			(false)
#define DEFAULT_VOLUME_LEVEL_MAX_VAL		uint32_t(200)
#define DEFAULT_VOLUME_LEVEL_VAL				uint32_t(100)
#define DEFAULT_VOLUME_STEP_VAL				uint32_t(1)
#define DEFAULT_WRAP_TRACK_INFO_VAL			(true)
#define DEFAULT_WRAP_TRACK_INFO_LEN_VAL	(40)
